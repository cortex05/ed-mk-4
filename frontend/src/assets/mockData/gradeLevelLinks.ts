export const mockGradeLinks = [
  {
    ...
    courseLinks: [
      {domain: "MATH", name: "Math", id: "K-MATH"}, 
      {domain: "READING", name: "Reading", id: "K-READING"}
    ]
  },{
    id: "FIRST_GRADE",
    ...
    courseLinks: [
      {domain: "MATH", name: "Math", id: "FIRST-MATH"}, 
      {domain: "READING", name: "Reading", id: "FIRST-READING"}
    ]
  },{
    id: "SEVENTH_GRADE",
